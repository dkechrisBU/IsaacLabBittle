...
import omni.isaac.lab_tasks.manager_based.locomotion.velocity.config.bittle.mdp as bittle_mdp
...
# Pre-defined configs
##
from omni.isaac.lab_assets.bittle import BITTLE_CFG  # isort: skip
...
class BittleEventCfg:
    ...
    reset_robot_joints = EventTerm(
        func=bittle_mdp.reset_joints_around_default,
        mode="reset",
        params={
...
@configclass
class BittleRewardsCfg:
    # -- task
    air_time = RewardTermCfg(
        func=bittle_mdp.air_time_reward,
        weight=5.0,
        params={
            "mode_time": 0.3,
    ...
    base_angular_velocity = RewardTermCfg(
        func=bittle_mdp.base_angular_velocity_reward,
        weight=5.0,
        params={"std": 2.0, "asset_cfg": SceneEntityCfg("robot")},
    )
    base_linear_velocity = RewardTermCfg(
        func=bittle_mdp.base_linear_velocity_reward,
        weight=5.0,
        params={"std": 1.0, "ramp_rate": 0.5, "ramp_at_vel": 1.0, "asset_cfg": SceneEntityCfg("robot")},
    )
    foot_clearance = RewardTermCfg(
        func=bittle_mdp.foot_clearance_reward,
        weight=0.5,
        params={
            "std": 0.05,
            "tanh_mult": 2.0,
    ...
    # -- penalties
    action_smoothness = RewardTermCfg(func=bittle_mdp.action_smoothness_penalty, weight=-1.0)
    ...
    base_orientation = RewardTermCfg(
        func=bittle_mdp.base_orientation_penalty, weight=-3.0, params={"asset_cfg": SceneEntityCfg("robot")}
    )
    ...
    joint_torques = RewardTermCfg(
        func=bittle_mdp.joint_torques_penalty,
        weight=-5.0e-4,
...
@configclass
class BittleFlatEnvCfg(LocomotionVelocityRoughEnvCfg):

    # Basic settings'
    observations: BittleObservationsCfg = BittleObservationsCfg()
    actions: BittleActionsCfg = BittleActionsCfg()
    commands: BittleCommandsCfg = BittleCommandsCfg()

    # MDP setting
    rewards: BittleRewardsCfg = BittleRewardsCfg()
    terminations: BittleTerminationsCfg = BittleTerminationsCfg()
    events: BittleEventCfg = BittleEventCfg()
    curriculum: BittleCurriculumCfg = BittleCurriculumCfg()
