...
* :obj:`BITTLE_CFG`: The Spot robot with delay PD and remote PD actuators.
"""
...
BITTLE_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        #usd_path=f"{ISAAC_NUCLEUS_DIR}/Robots/BostonDynamics/bittle/bittle.usd",
        usd_path=f"/home/student/Downloads/Bittle_URDF_test/bittle_esp32/bittle_esp32.usd",
    ...
    actuators={
        "bittle_hip": DelayedPDActuatorCfg(
            joint_names_expr=["hip_left", "hip_right", "shoulder_left", "shoulder_right"],
        ...
        "bittle_knee": RemotizedPDActuatorCfg(
            joint_names_expr=["knee_left","knee_right", "elbow_left", "elbow_right"],
